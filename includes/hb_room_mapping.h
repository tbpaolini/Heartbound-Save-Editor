...
#define STRUCT_LINE_BUFFER (size_t)256                  // Maximum number of characters per line
...
typedef struct HeartboundLocation
{
    ...
    size_t world;                     // Number of the world (0 - Global | 1 - Hometown | 2 - The Tower | 3 - Animus | 4 - Jotunheim | 5 - End)
...
// Length of the textures' path
static size_t texture_path_size;
